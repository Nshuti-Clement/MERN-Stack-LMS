...
const ReviewCard = (props: Props) => {
  return (
    <div className="w-full h-max pb-4  dark:bg-slate-500 dark:bg-opacity-[0.20] border border-[#03c03c] dark:border-[#03c03c] backdrop-blur shadow-[bg-slate-700] rounded-lg p-3 shadow-inner">
