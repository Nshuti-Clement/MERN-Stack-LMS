...
export const reviews = [
...
},
  {
    ...
    comment:
    "Thanks for your amazing programming tutorial channel! Your teaching style is outstanding, and the quality of your tutorials is top-notch. Your ability to break down complex topics into manageable parts, and cover diverse programming languages. and keep up the fantastic work!",
},
  {
    name: "Jay Gibbs",
    ...
    comment:
    "Thanks for your amazing programming tutorial channel! Your teaching style is outstanding, and the quality of your tutorials is top-notch. Your ability to break down complex topics into manageable parts, and passion for teaching programming, and keep up the fantastic work!"},
  {
    name: "Mina Davidson",
...
},
  {
    ...
    comment:
    "Join HealthEdu! HealthEdu focuses on practical applications rather than just teaching the theory behind  HealthEdu is a great resource that will help you take your skills to the next level.",
},
];
